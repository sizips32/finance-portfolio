...
class IncomeHandler:
    ...
    def delete(self, income_id: int) -> bool:
        ...
        try:
            ...
            logger.error(f"Error deleting income data: {e}")
            return False

    def update(self, income_id: int, data: Dict) -> bool:
        """수입 데이터 수정
        
        Args:
            income_id: 수정할 수입 데이터 ID
            data: 수정할 데이터
                {
                    'date': str,
                    'category': str,
        ...
        try:
            ...
            logger.error(f"Error updating income data: {e}")
            return False 
